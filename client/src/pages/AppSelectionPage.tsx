    ...
    <div className="min-h-screen pb-28 dark:bg-gray-900">
      ...
      <div className={`bg-gradient-to-br ${config.gradient} text-white relative overflow-hidden`}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-1/2 -right-1/4 w-[500px] h-[500px] bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-1/2 -left-1/4 w-[400px] h-[400px] bg-white/5 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white/15 backdrop-blur-sm rounded-2xl flex items-center justify-center text-3xl sm:text-4xl shadow-lg border border-white/20">
                  {config.icon}
                </div>
                <div>
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight">{t(config.titleKey)}</h1>
                  <p className="text-white/70 text-sm sm:text-base mt-0.5">{t(config.subtitleKey)}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 sm:gap-6 pt-2">
                <div className="flex items-center gap-2.5 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                  ...
                  <div>
                    <span className="text-xl sm:text-2xl font-bold">{totalApps}</span>
                    <span className="text-xs sm:text-sm text-white/60 ml-1.5">{t('appSelection.stats.totalApps')}</span>
                  </div>
                </div>
                <div className="flex items-center gap-2.5 bg-white/10 backdrop-blur-sm rounded-xl px-4 py-2.5 border border-white/10">
                  <svg className={`w-5 h-5 ${selectionCount > 0 ? 'text-green-300' : 'text-white/80'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <div>
                    <span className="text-xl sm:text-2xl font-bold">{selectionCount}</span>
                    <span className="text-xs sm:text-sm text-white/60 ml-1.5">{t('appSelection.stats.selected')}</span>
                  </div>
                </div>
                {selectionCount > 0 && (
                  <Link
                    to="/summary"
                    className="hidden sm:flex items-center gap-2 bg-white text-gray-900 px-4 py-2.5 rounded-xl font-semibold text-sm shadow-lg hover:bg-white/90 transition-colors"
                  >
                    {t('bottomBar.viewSummary')}
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/15">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-10 py-3 bg-white rounded-xl text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-white/50 border-0 shadow-lg text-base"
                  />
                  {searchQuery && (
                    <button
